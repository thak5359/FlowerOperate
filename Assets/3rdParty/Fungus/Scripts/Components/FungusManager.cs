...
namespace Fungus
{
    ...
    //[RequireComponent(typeof(MusicManager))] 코드 개조용 주석 처리
    [RequireComponent(typeof(CustomMusicManager))]
    ...
    public sealed class FungusManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            MusicManager = GetComponent<CustomMusicManager>();
        ...
        public AudioMixer UnityAudioMixer
        {
            get
            {
                return MainAudioMixer != null ? MainAudioMixer.Mixer : null;
            }
        }
