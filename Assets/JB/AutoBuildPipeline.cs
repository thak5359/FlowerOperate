...
class AutoBuildPipeline
{
    ...
    {
        // Addressables의 BuildAddressablesWithPlayerBuild 설정을 임시로 DoNotBuildWithPlayer로 변경하여 중복 빌드 방지
        var settings = AddressableAssetSettingsDefaultObject.Settings;
        var originalBuildOption = AddressableAssetSettings.PlayerBuildOption.DoNotBuildWithPlayer;
        if (settings != null)
        {
            originalBuildOption = settings.BuildAddressablesWithPlayerBuild;
